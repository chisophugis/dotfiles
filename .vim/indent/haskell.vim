...
if !exists('g:haskell_indent_case_of')
    " case xs of
    "         >>>[] -> ...
    "         >>>(y:ys) -> ...
    let g:haskell_indent_case_of = 3
endif
...
setlocal expandtab "needed for haskell to recognize where lineups
...
function! GetHaskellIndent()
	...
	"prefer to line them up after the of, and not the case
        return s + g:haskell_indent_case_of
    endif
