...
"yasm supports these with immediate expansion by prepending 'x'
syn match   nasmDefine		"^\s*%x\?\(assign\|define\)\>"hs=e-6
syn match   nasmDefine		"^\s*%x\?i\(assign\|define\)\>"hs=e-7
